...
/**
 *  \defgroup   timetable Module TimeTable
 *  \brief      TimeTable module descriptor.
 *
 *  \file       htdocs/mymodule/core/modules/modTimeTable.class.php
 *  \ingroup    timetable
...
/**
 *  Description and activation class for module TimeTable
 */
class modTimeTable extends DolibarrModules
{
    /**
    ...
    public function __construct($db)
    {
        ...
        $this->numero = 666666; // TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve an id number for your module
        // Key text used to identify module (for permissions, menus, etc...)
        $this->rights_class = 'timetable';
        ...
        $this->description = "Generation of timetables";
        // Used only if file README.md and README-LL.md not found.
        $this->descriptionlong = "Generation of timetables";
        $this->editor_name = 'AGENIUM SCALE';
        $this->editor_url = 'https://www.agenium-scale.com';
        ...
        $this->dirs = array("/timetable/temp");
        ...
        $this->langfiles = array("timetable@timetable");
        ...
        */
        ...
        $this->rights[$r][1] = 'Generate timetables';  // Permission label
        ...
        $this->menu[$r++]=array(
            ...
            'mainmenu'=>'timetable',
            'leftmenu'=>'',
            'url'=>'/timetable/index.php',
            'langs'=>'timetable@timetable',           // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
            'position'=>1000+$r,
            'enabled'=>'$conf->timetable->enabled',  // Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled.
            'perms'=>'$user->rights->timetable->read', // Use 'perms'=>'$user->rights->mymodule->level1->level2' if you want your menu with a permission rules
            'target'=>'',
